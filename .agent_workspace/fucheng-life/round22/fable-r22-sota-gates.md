...
> **红灯现况（写作时实测）**：`./scripts/run-fucheng-life-tests.sh` 当时 **32 过 1 挂**——
...
> **落笔后勘定**：`dae9ea2` 已按 G-8 口径放宽 r21 正则、`31e417e` 落了 o5-skip.md——
> 本机复跑 **33 项全绿**，G-8 红灯与 O5 缺口双销；G-8/G-7 条文保留原文作定罪与验收依据。
...
——两件均已在落笔后由 `dae9ea2` / `31e417e` 销掉（本机复跑 33 全绿）；
剩余收口动作：A/B 组手测过一遍 + §45 打勾。
