...
| R2 | **in_progress** | 5/6 已交付；仅剩 R2-C 浏览器 MANUAL §21–25 |
...
- story.json `events.length` = **82**（+21 时代专属 +5 once +8 补标）
- pick 过滤：era ×2 加权、minMonths、once 落账 — R2-B 冒烟 29/6/5 fixtures 全过
- `originSagas` = **10**；MANUAL §21–25 待 R2-C

## 放行线
- **R1 AUTO**：✅
- **R2 AUTO**：✅（pick/once/era 硬断言已绿）
- **R2 MANUAL**：⏳ 待 R2-C 浏览器走 ACCEPTANCE §21–25
