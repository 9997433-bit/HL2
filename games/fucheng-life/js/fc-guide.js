/* 浮城人生 · fc-guide.js — 聚光灯式逐步教学（coach marks）
   R18：文案增量不升 KEY —— 只改正文的轮次沿用 v7，仅结构性改版才 bump。 */
(function (global) {
  "use strict";
  ...
  var STEPS = [
    ...
    },
    {
      ...
      body: "入城头三个月会让你签一张合约（落户 / 首付 / 升职）。进度条一直挂在这里，到期城市会结算。" +
        ...
        "日志里打「合约」标签的城市事件（要不要接这单之类）要看合约还在不在：合约还在进行中，没确认就刷新，下次进门原样再弹一次；" +
        "合约已经结算或失效了，那张门禁通知就自动作废，日志里留一行说明，不会再补弹。",
      target: "contractHud",
      fallback: "vitalsPanel"
    },
    {
      title: "⑤ 生命体征",
      body: "现金、健康、人脉、声望在这里跳动。现金见底会破产；健康跌到临界会急救一次，再跌就要提前离场。手机可点「展开」看完整项。",
      target: "vitalsPanel",
      fallback: "moneyStat"
    },
    {
