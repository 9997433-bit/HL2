...
**现在就玩**：<https://9997433-bit.github.io/HL2/games/fucheng-life/>

## 推荐开局（约 20–40 分钟一局）

1. 选年代 → 选出身上勾选 **「闯城 60 月」** → 把 8 点属性分完 → 开始人生  
2. 进仪表盘：选职业轨道 → 选定闯城主目标 →（可选）签合约 → 教学可跳过  
3. 每月花完行动点（上班 / 休息 / 探区等）→ 点「推进一月」；手机用底栏  
4. 满 60 月交卷看结局；「快进 6 月」可加速。重开会确认并重新问目标  

完整人生模式更长：可用快进；约入城十年且满 62 岁可退休。健康急救只有一次。
